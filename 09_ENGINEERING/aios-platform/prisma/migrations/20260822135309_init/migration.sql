-- CreateEnum
CREATE TYPE "PlatformRole" AS ENUM ('ADMIN', 'MEMBER', 'VIEWER');

-- CreateEnum
CREATE TYPE "ModuleStatus" AS ENUM ('ACTIVE', 'COMING_SOON');
...
-- CreateIndex
CREATE UNIQUE INDEX "PlatformModule_order_key" ON "PlatformModule"("order");
