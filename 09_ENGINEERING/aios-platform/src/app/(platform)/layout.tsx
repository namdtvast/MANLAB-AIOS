  ...
  return (
    <div className="flex flex-1">
      ...
      <div className="flex flex-1 flex-col">
        <header className="sticky top-0 z-10 flex items-center justify-between border-b border-border bg-surface/85 px-6 py-3 backdrop-blur">
          <div />
          <div className="flex items-center gap-3">
            ...
            >
              <button
                type="submit"
                className="flex cursor-pointer items-center gap-1.5 rounded-lg border border-border px-3 py-1.5 text-sm text-ink-2 transition-colors hover:border-border-strong hover:text-ink"
              >
                <svg
                  aria-hidden
                  viewBox="0 0 20 20"
