              ...
              {plans.map((p) => (
                <tr key={p.id} className="border-b border-border last:border-0 hover:bg-sunk">
                  <td className="px-3 py-2">
                    <Link href={`/modules/M17/plan/${p.id}`} className="font-mono text-xs font-medium text-accent hover:underline">
                      {p.code}
                    </Link>
                  </td>
            ...
            <tbody>
              {minutes.map((m) => (
                <tr key={m.id} className="border-b border-border last:border-0 hover:bg-sunk">
                  <td className="px-3 py-2">
                    <Link href={`/modules/M17/minutes/${m.id}`} className="font-mono text-xs font-medium text-accent hover:underline">
                      {m.code}
                    </Link>
                  </td>
