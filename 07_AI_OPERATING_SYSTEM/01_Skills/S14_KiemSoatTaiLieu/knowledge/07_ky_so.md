...
> Căn cứ pháp lý đầy đủ: `knowledge/01_phap_luat.md`, `08_KNOWLEDGE_GRAPH/01_Regulations/`. Quy định nội bộ gốc: `ETV.P14` VI.7 (Chữ ký số & chữ ký điện tử).
...
- Văn bản đã qua đủ bước Soát xét/Phê duyệt trước khi tới bước ký số chưa (đối chiếu `status` tại `knowledge/05_vong_doi_van_ban.md` và `ETV.P14` VI.6)?
