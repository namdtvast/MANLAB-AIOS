# Checklist — Thủ tục/Quy trình/Hướng dẫn (Procedure)

- [ ] Đủ 8 mục khung chuẩn (xem `templates/thu_tuc.md`): Mục đích, Phạm vi, Tài liệu viện dẫn, Thuật ngữ, RACI, Nội dung/quy trình, Biểu mẫu, Lưu hồ sơ
- [ ] Không chép nội dung luật/ISO — chỉ dẫn chiếu (kiểm tra chéo `validation/checklist_legal_compliance.md`, `checklist_iso_compliance.md`)
- [ ] RACI đầy đủ vai trò LĐV/LĐP/NTH và (nếu có) Văn thư/QLCL
