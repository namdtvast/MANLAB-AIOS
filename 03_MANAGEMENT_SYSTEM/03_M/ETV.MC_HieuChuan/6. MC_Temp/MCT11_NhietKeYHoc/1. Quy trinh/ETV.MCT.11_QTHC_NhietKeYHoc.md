---
id: ETV.MCT 11
title: "Nhiệt kế y học thuỷ tinh — thuỷ ngân có cơ cấu cực đại — Quy trình hiệu chuẩn"
type: Quy-trinh
...
revision: "02"
status: Da-ban-hanh
keywords: [nhiệt kế y học, clinical thermometer, cơ cấu cực đại, hiệu chuẩn]
related_documents: []
iso_clause: ["ISO/IEC 17025:2017"]
legal_basis: ["ĐLVN 113:2003", "ĐLVN 131:2003", "ĐLVN 21:2017"]
ai_tags: [calibration-procedure, clinical-thermometer, mercury-thermometer, uncertainty-budget]
knowledge_category: HTQL-noi-bo
permission: Noi-bo
retention: "Theo ETV.P.F 14.06"
digital_signature: "Nguyễn Hoàng Giang"
source: "Viện Kiểm định Công nghệ và Môi trường (ETV) — chuyển đổi định dạng từ bản PDF gốc `ETV.MCT 11_NK y hoc TT-TN CCCD_V2.pdf`"
supersedes: "ETV.MCT 11 lần ban hành 01 (19/05/2020)"
superseded_by: null
---
...
> **Tình trạng bản này:** Bản chuyển đổi định dạng (PDF → Markdown) từ file gốc `ETV.MCT 11_NK y hoc TT-TN CCCD_V2.pdf` do Viện ban hành, phục vụ tra cứu trên ManLab. Khối chữ ký trong bản gốc để trống, chưa có tên người biên soạn.
...
Văn bản kỹ thuật này quy định quy trình hiệu chuẩn ban đầu nhiệt kế y học thuỷ tinh thuỷ ngân có cơ cấu cực đại (sau đây gọi là nhiệt kế cần hiệu chuẩn) dùng để đo nhiệt độ cơ thể, có phạm vi đo từ 34 °C đến 42 °C, có giá trị độ chia 0,1 °C.
...
| --- | --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Chuẩn đo lường**                            |                                                                                                                                |
|     | Nhiệt kế chuẩn                                | Phạm vi đo phù hợp với phạm vi của nhiệt kế cần hiệu chuẩn; độ không đảm bảo đo mở rộng không lớn hơn 0,05 °C; độ không đảm bảo đo của tổ hợp chuẩn so với nhiệt kế thỏa mãn tỉ số truyền chuẩn ≤ 1/3 |
...
- **d.** Số điểm nhiệt độ kiểm tra: kiểm tra đo lường được thực hiện tại hai điểm nhiệt độ là 37 °C ± 0,05 °C và 41 °C ± 0,05 °C.

#### 7.3.2. Tiến hành kiểm tra

- **a.** Vẩy bằng tay hoặc máy chuyên dụng (nếu có) cho cột thuỷ ngân của nhiệt kế bị kiểm hạ thấp hơn nhiệt độ cần kiểm tra ít nhất 0,5 °C.

  *Ghi chú:* Nếu số chỉ của nhiệt kế cần hiệu chuẩn đã thấp hơn nhiệt độ cần kiểm tra 0,5 °C thì bỏ qua thao tác này.
