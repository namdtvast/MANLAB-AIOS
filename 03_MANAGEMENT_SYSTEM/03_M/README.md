...
|---|---|---|
| Thủ tục quản lý `ETV.Pxx` | `ETV.P.F {xx}.{yy}` | `06_SHARED_RESOURCES/01_Forms/` — một nguồn sự thật dùng chung cho nhiều thủ tục; `03_MANAGEMENT_SYSTEM/04_F/` chỉ là mục lục điều hướng, không chứa file biểu mẫu |
