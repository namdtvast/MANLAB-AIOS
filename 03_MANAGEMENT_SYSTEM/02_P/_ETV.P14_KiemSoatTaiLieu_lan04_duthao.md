...
| ------------------------- | -------------------- |
| **Mã số**         | ETV.P 14             |
| **Lần ban hành**  | 04 *(dự thảo)*       |
| **Ngày ban hành** | *(chưa ấn định)*     |
| **Biên soạn**     | Dương Thành Nam  |
| **Soát xét**      | *(chưa soát xét)*               |
| **Phê duyệt**     | *(chưa phê duyệt)*              |

> ## ⚠ BẢN DỰ THẢO — KHÔNG CÓ HIỆU LỰC
>
> **Bản đang có hiệu lực là lần ban hành 03** tại [`ETV.P14_KiemSoatTaiLieu.md`](ETV.P14_KiemSoatTaiLieu.md), hiệu lực từ 01/07/2026. Tệp này **không** thay thế bản đó cho tới khi LĐV phê duyệt.
>
> Tên tệp bắt đầu bằng `_` nên `_meta/extract_documents_metadata.py` bỏ qua — bản dự thảo không được đăng ký là văn bản kiểm soát và không tranh mã `ETV.P14` với bản đang hành.
>
> **Phạm vi dự thảo:** chỉ §6.2 (bảng mã hoá) và các mục bắt buộc đồng bộ theo. Phần còn lại **giữ nguyên từng ký tự** của lần 03 — tệp này được tạo bằng cách sao chép bản lần 03 rồi áp đúng bốn chỗ sửa, không soạn lại.
>
> **Căn cứ:** phiếu [`ETV.P.F14.01_2026-08-30_P14_KyHieuLinhVucAI`](../04_F/ETV.P.F14.01_2026-08-30_P14_KyHieuLinhVucAI.md), **chưa qua LĐP thẩm định** (ETV.P14 §6.6.1 bước 2). Soạn trước bước 3 theo yêu cầu, để LĐP có bản toàn văn khi thẩm định.
>
> **Khi LĐV phê duyệt:** chép nội dung tệp này đè lên `ETV.P14_KiemSoatTaiLieu.md`, đặt `effective_date` và `status: Da-phe-duyet`, điền ngày soát xét/phê duyệt, rồi **xoá tệp dự thảo này**. Nếu lần 03 bị sửa trong thời gian chờ, phải áp lại thay đổi đó vào đây trước khi trình.
...
*Thủ tục Kiểm soát tài liệu, dữ liệu, thông tin — ETV.P 14 — Lần BH: 04 (dự thảo) — Trang tài liệu điện tử, không áp dụng đánh số trang thủ công (bản in xuất từ ManLab tự sinh header/footer theo §8).*
