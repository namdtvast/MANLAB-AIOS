...
| Hồ sơ nhân sự | Sơ yếu lý lịch, hợp đồng lao động, giấy phép chuyên môn (theo ETV.P03) |
...
- **Hồ sơ nội bộ:** Lập tạo bởi ETV, quản lý trọn vẹn vòng đời
  - Kỹ thuật: Báo cáo kiểm định, hiệu chuẩn, thử nghiệm, dữ liệu thô
...
**Soát xét định kỳ:**
- Hàng năm: Kiểm tra toàn bộ hồ sơ đang giữ (tồn tại, đầy đủ, không hỏng hóc)
- Nếu phát hiện tổn hại (ẩm, mối mọt, phai mờ, file bị lỗi): Tạo bản photo/quét lại, cập nhật trên ManLab
...
### 6.9 Xử lý hồ sơ bị tổn thương hoặc mất mát

- **Phát hiện mất/hỏng:** LĐP lập báo cáo ngay (nguyên nhân, phạm vi ảnh hưởng)
- **Đánh giá tác động:** 
...
| `ETV.P.F 15.04` | Báo cáo sự cố mất/hỏng hồ sơ |
