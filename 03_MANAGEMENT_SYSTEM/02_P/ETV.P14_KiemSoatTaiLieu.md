...
### VI.1 Phân loại văn bản & quy tắc mã hoá
...
### VI.2 Quy tắc mã hoá (giữ nguyên nguyên tắc đã áp dụng từ 2019)
...
### VI.3 Metadata chuẩn của văn bản
...
### VI.6 Vòng đời văn bản — quy trình thực hiện

### VI.6.1 Văn bản nội bộ (đi)
...
### VI.6.3 Văn bản điện tử trên ManLab
...
### VI.9 Vai trò của AI trong kiểm soát tài liệu
...
### VI.10 Soát xét định kỳ & xử lý xung đột

Toàn bộ văn bản HTQL (Sổ tay, Thủ tục, Quy trình, Hướng dẫn) được soát xét định kỳ **tối đa 36 tháng/lần**, độc lập với soát xét phát sinh theo nhu cầu (VI.5.1 bước 10).
