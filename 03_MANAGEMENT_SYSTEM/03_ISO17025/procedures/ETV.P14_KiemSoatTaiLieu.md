...
> **Lưu ý phạm vi:** Luật Ban hành văn bản quy phạm pháp luật điều chỉnh **cơ quan nhà nước có thẩm quyền ban hành VBQPPL**. ETV không ban hành VBQPPL, chỉ tiếp nhận và áp dụng (văn bản bên ngoài) — do đó luật này không phải căn cứ ban hành văn bản nội bộ của ETV, chỉ liên quan khi xử lý văn bản bên ngoài tại VI.5.2.
...
### 6.2 Metadata chuẩn của văn bản
...
### 6.3 Thể thức trình bày

Tách bạch theo đúng phạm vi điều chỉnh pháp luật (xem phân tích tại §6, mục 4 của [ETV.P14_PhanTich_ThietKeLai.md](ETV.P14_PhanTich_ThietKeLai.md)):

| Nhóm văn bản | Thể thức áp dụng | Mẫu (template) |
|---|---|---|
| Quyết định, Công văn, Thông báo, Biên bản, Báo cáo (văn bản hành chính) | **Bắt buộc theo Phụ lục I, Nghị định 30/2020/NĐ-CP**: Quốc hiệu — Tiêu ngữ, tên cơ quan, số/ký hiệu, địa danh — ngày tháng, nơi nhận | `07_AI_OPERATING_SYSTEM/01_Skills/etv-document-governance/templates/` |
...
### 6.5 Vòng đời văn bản — quy trình thực hiện

### 10.1 Văn bản nội bộ (đi)
...
### 10.3 Văn bản điện tử trên ManLab
...
1. Ưu tiên phát hành văn bản điện tử có chữ ký số; chữ ký tay áp dụng khi chưa đủ điều kiện hạ tầng.
2. Viện trưởng giao văn thư quản lý khóa bí mật con dấu tổ chức; mỗi cá nhân tự chịu trách nhiệm bảo mật khóa bí mật cá nhân, không chuyển giao khi chưa có ủy quyền bằng văn bản.
3. Chỉ ký số vào văn bản sau khi đã có đủ chữ ký/phê duyệt theo đúng luồng RACI (III); không ký số thay quy trình soát xét/phê duyệt.
4. Thẩm quyền ký số theo từng loại văn bản cụ thể: xem `ETV.P.F 14.06`.

### 6.7 Phân quyền hệ thống
...
### 6.8 Vai trò của AI trong kiểm soát tài liệu

ETV sử dụng Claude Skill **`etv-document-governance`** (tại `07_AI_OPERATING_SYSTEM/01_Skills/etv-document-governance/`) để hỗ trợ: nhận diện loại văn bản, gợi ý mã số, kiểm tra thể thức, kiểm tra căn cứ pháp lý/ISO, phát hiện xung đột, nhắc soát xét định kỳ, khởi tạo metadata.
...
### 6.9 Soát xét định kỳ & xử lý xung đột

1. Toàn bộ văn bản HTQL (Sổ tay, Thủ tục, Quy trình, Hướng dẫn) được soát xét định kỳ **tối đa 36 tháng/lần**, độc lập với soát xét phát sinh theo nhu cầu (VI.5.1 bước 10).
2. Khi phát hiện hai văn bản có phạm vi trùng lặp hoặc nội dung mâu thuẫn (do AI cảnh báo hoặc do NTH phát hiện), LĐP phụ trách phải lập phiếu soát xét hợp nhất trong vòng 15 ngày làm việc.
3. Khi văn bản bên ngoài dẫn chiếu (Luật/Nghị định/TCVN...) được thay thế, LĐP rà soát và cập nhật `legal_basis`/`iso_clause` của văn bản nội bộ liên quan trong vòng 30 ngày kể từ ngày văn bản mới có hiệu lực.

### 6.10 Thanh lý, hủy bỏ, lưu trữ
