...
| Trường | Nội dung |
|---|---|
| Mã văn bản đề nghị (nếu soát xét văn bản hiện có) | **ETV.MCF 08** |
...
## Ý kiến LĐP (thẩm định sự cần thiết)
...
### Phạm vi thay đổi (đính kèm phiếu)

| # | Vị trí | Trước (lần BH 02) | Sau (lần BH 03) |
|---|---|---|---|
| 1 | Mục 1–9 (thân bài) | Nội dung sao chép nguyên văn từ `ETV.MCF 05` (LLKH: đập tràn/máng Parshall, hệ số Cd/C0...) — sai đối tượng | Biên soạn lại đúng đối tượng "phương tiện đo mức tự động": phạm vi áp dụng, giải thích từ ngữ, phương tiện hiệu chuẩn, điều kiện, chuẩn bị, tiến hành hiệu chuẩn (bên ngoài/kỹ thuật/đo lường), tính ĐKĐB (u_A, u_B1, u_B2, u_B3 — độ trôi điểm "0"), xử lý chung, phụ lục |
| 2 | Frontmatter: `revision` | `02` | `03` |
| 3 | Frontmatter: `effective_date`, `prepared_date`, `reviewed_date`, `approved_date` | `22/04/2026` | `11/08/2026` |
| 4 | Frontmatter: `supersedes` | `ETV.MCF 08 lần ban hành 01 (22/04/2019)` | `ETV.MCF 08 lần ban hành 02 (22/04/2026)` |
| 5 | Bảng "NHỮNG THAY ĐỔI ĐÃ CÓ" | 2 dòng (lần 1, 2) | Thêm dòng lần 3, ghi rõ lý do sửa |
| 6 | `03_M/README.md` — mô tả nhóm MCF | "toàn bộ nội dung thân bài là bản sao gần như nguyên văn từ MCF05" | Cập nhật: đã soát xét lại lần ban hành 03, biên soạn đúng đối tượng, còn chờ soát xét/phê duyệt chính thức |

**Tham chiếu commit/PR liên quan (không thay thế hồ sơ chính thức):** [PR #42](https://github.com/namdtvast/MANLAB-AIOS/pull/42) — nội dung thay đổi; [PR #43](https://github.com/namdtvast/MANLAB-AIOS/pull/43) — chỉnh sửa ghi chú.
