...
| Hướng dẫn | `ETV.GAI 01` — Tích hợp máy chủ mô hình AI nội bộ vào ManLab AIOS (**ban hành lần 01, hiệu lực 30/08/2026**) · `ETV.GAI 02` — Kiến trúc tri thức và ngữ nghĩa cho AI trong hệ sinh thái ManLab (bản **nháp**). Ký hiệu `AI` đã đăng ký tại ETV.P14 §6.2 lần ban hành 04 |
