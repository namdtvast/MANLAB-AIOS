...
> **Nguyên tắc:** Danh mục này là **sổ đăng ký**, không phải kho cấu hình. Cột "Hồ sơ gốc" bắt buộc ghi đường dẫn tới nơi lưu hồ sơ thật. **Nghiêm cấm** ghi mật khẩu, khóa API, chứng thư số vào bất kỳ cột nào của biểu mẫu này (ETV.P35 mục 1.3).
...
| Mức trọng yếu | Thấp · Trung bình · Cao (Cao bắt buộc có rủi ro ETV.MP01 + phương án liên tục ETV.MP31) |
| Mức phân loại dữ liệu | Công khai · Nội bộ · Hạn chế · Mật (theo ETV.MP02/MP27/MP28 — ghi theo mức **cao nhất** nền tảng xử lý) |
...
| TT | Mã nền tảng | Nền tảng đối tác | Hướng dữ liệu (Đi/Đến/Hai chiều) | Loại dữ liệu trao đổi | Mức phân loại cao nhất | Phương thức xác thực | Nơi lưu bí mật xác thực (ETV.MP28) | Hợp đồng dữ liệu (ETV.MP37) | Tình trạng |
|---|---|---|---|---|---|---|---|---|---|
| 1 | | | | | | | | | |
| 2 | | | | | | | | | |
...
*(Theo ETV.P35 mục 5.2.3 — LĐV phê duyệt ngoại lệ, thời hạn khắc phục không quá 90 ngày)*

| TT | Mã nền tảng | Điều kiện còn thiếu | Lý do phê duyệt ngoại lệ | Mã rủi ro (ETV.MP01) | Ngày phê duyệt | Hạn khắc phục | Tình trạng khắc phục |
|---|---|---|---|---|---|---|---|
| 1 | | | | | | | |
| 2 | | | | | | | |
...
| TT | Mã nền tảng | Tên nền tảng | Lý do (bắt buộc) | Nền tảng thay thế | Số phiếu F35.04 | Ngày hết hiệu lực | Đã xử lý xong dữ liệu (MP27/MP34) |
|---|---|---|---|---|---|---|---|
| 1 | | | | | | | ☐ |
| 2 | | | | | | | ☐ |
...
*(Theo ETV.P35 mục 5.6)*

| TT | Tên nền tảng | Người/đơn vị đang sử dụng | Dữ liệu đã đưa lên | Mức phân loại | Hướng xử lý (Đăng ký / Ngừng sử dụng) | Số KPH (ETV.MP13) nếu có | Hạn hoàn thành |
|---|---|---|---|---|---|---|---|
| 1 | | | | | | | |
| 2 | | | | | | | |
...
> Người lập ≠ người phê duyệt. Mọi bản ghi nền tảng do **Lãnh đạo Viện** phê duyệt (ETV.P35 mục 4.1). Hồ sơ lưu theo ETV.MP15.
