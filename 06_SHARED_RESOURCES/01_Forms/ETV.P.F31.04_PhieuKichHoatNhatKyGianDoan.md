---
id: ETV.P.F31.04
title: "Phiếu kích hoạt và nhật ký gián đoạn"
type: Bieu-mau
...
related_documents: [ETV.P31, ETV.P.F31.01, ETV.P.F31.02, ETV.P.F31.03]
---
# PHIẾU KÍCH HOẠT VÀ NHẬT KÝ GIÁN ĐOẠN
...
| Trường | Nội dung |
|---|---|
| Người đề nghị kích hoạt | *(CHUP)* |
| **Người quyết định** | ☐ TP *(Mức A)*　☐ Lãnh đạo Viện *(Mức B, C)* — Họ tên: ................ |
| Thời điểm quyết định | ..../..../........ ...... giờ ...... |
| Phương án áp dụng (theo F31.02) | |
| Đội ứng phó huy động | |

## 3. Nhật ký ứng phó theo mốc thời gian

*(Cập nhật tình hình cho LĐV: Mức C ≤ 04 giờ/lần · Mức B ≤ 01 ngày/lần)*

| Thời điểm | Diễn biến / Quyết định | Người quyết định | Nguồn lực huy động | Người ghi |
|---|---|---|---|---|
| | | | | |
| | | | | |
| | | | | |
...
| Quá trình | RTO mục tiêu | Thời điểm khôi phục thực tế | Thời gian gián đoạn thực tế | Đạt RTO | Dữ liệu mất thực tế | Đạt RPO |
|---|---|---|---|---|---|---|
| | | | | ☐ | | ☐ |
| | | | | ☐ | | ☐ |
...
| TT | Điều kiện | Đạt |
|---|---|---|
| 1 | Nguyên nhân gián đoạn đã được xử lý hoặc kiểm soát | ☐ |
| 2 | Các quá trình đã khôi phục về mức hoạt động thông thường | ☐ |
| 3 | Kiểm soát ATTT bị nới lỏng **đã khôi phục nguyên trạng** (mục 4) | ☐ |
| 4 | Dữ liệu phát sinh trong thời gian dự phòng đã nhập đủ vào hệ thống chính thức và đã đối chiếu | ☐ |
| 5 | **Đã hoàn tất rà soát hiệu lực công việc** (mục 7) | ☐ |

**Thời điểm tuyên bố trở lại bình thường:** ..../..../........ ...... giờ ......

**Người tuyên bố:** *(Lãnh đạo Viện)* ...............................................
...
| Nội dung | Ghi nhận |
|---|---|
| Điều gì trong kế hoạch **đã đúng** | |
| Điều gì **sai hoặc thiếu** | |
| Thời gian khôi phục thực tế so với RTO/RPO | |

| TT | Hành động cải tiến | Người chịu trách nhiệm | Thời hạn | Hoàn thành |
|---|---|---|---|---|
| 1 | | | | ☐ |
| 2 | | | | ☐ |
...
| Người chỉ huy ứng phó | Người rà soát hiệu lực | Người đóng nhật ký |
| --- | --- | --- |
