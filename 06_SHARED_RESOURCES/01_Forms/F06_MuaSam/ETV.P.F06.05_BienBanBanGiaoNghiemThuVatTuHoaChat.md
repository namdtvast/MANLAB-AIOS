---
id: ETV.P.F06.05
title: "Biên bản bàn giao, nghiệm thu Mẫu chuẩn"
type: Bieu-mau
...
| **Thủ tục áp dụng** | ETV.P 06 — mục 6.2 · ETV.P05 — mục 6.5 (Bước 7, 8) |

Địa điểm giao nhận: `DiaDiemGiaoNhan`

Bên giao: `BenGiao` · Địa chỉ: `DiaChiBenGiao`

Bên nhận: `BenNhan` · Địa chỉ: `DiaChiBenNhan`

| TT | Tên hàng hóa, vật tư | Yêu cầu kỹ thuật | Hãng/nước sản xuất | Đơn vị tính | Số lượng | Tình trạng (bao bì, ngoại quan, hồ sơ, chất lượng) | Ghi chú |
|---|---|---|---|---|---|---|---|
| | | | | | | | |
...
Footer: ETV.P.F 06.05 · Lần BH: 03 · Ngày BH: 21/07/2026 · Soát xét: 21/07/2026 · Trang 1/1
