...
|---|---|---|---|
| POST | `/taisantt` | Người lập | Tạo bản ghi (Nháp) |
| GET | `/taisantt/{id}` | Nội bộ | Xem chi tiết |
| PUT | `/taisantt/{id}` | Người lập | Sửa (khi Nháp) |
| POST | `/taisantt/{id}/submit-review` | Người lập | → Chờ soát xét |
| POST | `/taisantt/{id}/approve` | Người phê duyệt | → Đã phê duyệt |
| GET | `/taisantt/{id}/audit` | Quản trị | Nhật ký thao tác |
