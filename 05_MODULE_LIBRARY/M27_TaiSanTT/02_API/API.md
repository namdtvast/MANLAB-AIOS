...
| POST | `/taisantt/{id}/ai-use` | QLCL + QT hệ thống | Bật/tắt `ai_use_allowed` — chỉ với tài sản Đang sử dụng và `classification ∈ {Công khai, Nội bộ}` (quy tắc 12, `ETV.P28` mục 6.7) |
