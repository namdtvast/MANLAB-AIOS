# M18_QuyTacQuyetDinh — Mô hình dữ liệu
...
|---|---|---|
| `QuyTacQuyetDinh` | Quy tắc quyết định, tuyên bố phù hợp | PK `id`; FK (cập nhật) |
| `AuditLog` | Nhật ký thao tác | FK `quytacquyetdinh_id`; append-only |
