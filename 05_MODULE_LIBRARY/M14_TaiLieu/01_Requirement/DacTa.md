...
Định nghĩa gốc và duy nhất của metadata nằm tại ETV.P14 §6.3 — bảng dưới đây chỉ ánh xạ sang tên trường trong hệ thống, **không định nghĩa lại ý nghĩa**.
...
4. Văn bản `type ∈ {Sổ tay, Thủ tục}` bắt buộc người phê duyệt = tài khoản nhóm **LĐV**, không ủy quyền (theo RACI tại ETV.P14 III).
5. Khi `status → Hết hiệu lực/Hủy`, bắt buộc chọn `Thanh lý` hoặc `Hủy bỏ` (khác hành vi — ETV.P14 §6.11) và bắt buộc `reason`.
...
## 4. Vai trò
Người lập · Người soát xét (LĐP) · Người phê duyệt (LĐV) · Văn thư/QLCL (cấp mã, phân phối, lưu trữ) — chi tiết RACI: ETV.P14 III.
