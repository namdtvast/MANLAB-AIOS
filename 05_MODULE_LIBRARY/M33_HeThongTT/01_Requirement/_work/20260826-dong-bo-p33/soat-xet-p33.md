...
Thân văn bản viện dẫn **ETV.P08** (tại ETV.P33 §6.3.4), **ETV.P11** (§6.5.3), **ETV.P16** (§5.2),
**ETV.P26** (§6.5.4) và **ETV.P32** (§2.3) — số mục trong ngoặc là **nơi đặt câu viện dẫn trong
ETV.P33**, không phải điều khoản của thủ tục được dẫn — nhưng khối metadata và ETV.P33 §3.3 không
liệt kê chúng. Cả 05 thủ tục đều tồn tại trong
`03_MANAGEMENT_SYSTEM/02_P/`. **Đã bổ sung** vào `related_documents` và ETV.P33 §3.3, kèm sửa tên gọi cho
